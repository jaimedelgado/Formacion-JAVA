...
public class Sv1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 * 
		 * En la vida real esa factura la obtendríamos a partir de una id como 
		 * consulta a una base de datos.
		 * 
		 * El servlet podría establecer una conexión, realizar una query, 
		 * recorrer el resultset y "montar" el objeto.
		 * 
		 * Lo ideal es que el servlet disponga de un objeto especializado en la obtención de objetos
		 * de la base de datos, es decir, un DAO.
		 * 
		 */
		
		Cliente cliente = new Cliente(1020, "Pepin Gálvez Ridruejo", "912203456", "467984152K");
