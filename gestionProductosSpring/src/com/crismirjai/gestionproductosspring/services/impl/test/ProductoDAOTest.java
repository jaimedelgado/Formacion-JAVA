package com.crismirjai.gestionproductosspring.services.impl.test;
...
public class ProductoDAOTest {
	...
	public void guardarProductoTest() {
		...
		c.set(2015, 2, 1);
		ipd.guardarProducto(new Producto(String.valueOf(Integer.MAX_VALUE-3), "TESTGUARDAR", new Date(), 100.5, 30));
		assertNotNull(ipd.getProductoById(String.valueOf(Integer.MAX_VALUE-1)));
	}
	/**
